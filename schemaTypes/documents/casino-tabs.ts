...
export const casinoTabsSettings = defineType({
  name: "casinoTabsSettings",
  title: "Casino Tabs Configuration",
  type: "document",
  ...
  fields: [
    defineField({
      ...
      type: "string",
      description:
        "e.g. 'tab', 'casinoTab', 'section' → will be used as ?tab=lobby",
      initialValue: "tab",
